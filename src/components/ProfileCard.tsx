...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  avatarUrl = 'https://placehold.co/400x600/png', // Default placeholder
  iconUrl = '',
  grainUrl = '',
  innerGradient,
    ...
    >
      ...
      <div ref={shellRef} className="relative z-[1] group">
        <section
          ...
          style={{
            height: '80svh', // You might want to adjust this to '400px' if it feels too big!
            maxHeight: '540px',
            aspectRatio: '0.718',
            borderRadius: cardRadius,
        ...
        >
          ...
          >
            ...
            {/* Floating Text (Name/Title inside Card) */}
            <div
            ...
            >
              <div className="w-full absolute flex flex-col" style={{ top: '3em', display: 'flex' }}>
                <h3
